...
```java
public class sndersonLuca {

    String[] roles     = {"Full Stack Developer", "Java Back-End", "JS Front-End"};
    String   location  = "Brasil 🇧🇷";
    String[] currently = {"Construindo projetos full stack", "Aprendendo todos os dias"};

    String passion() {
        return "Transformar ideias em código limpo e escalável.";
    }
}
```
...
<img src="https://github-readme-streak-stats.herokuapp.com/?user=lucayof&theme=radical&hide_border=true" alt="GitHub Streak" />
